  ...
  return (
    <div style={{ animation: 'fadeIn .3s ease' }}>
      <div style={{ marginBottom: '20px' }}>
        <h1 style={{ fontSize: '26px', fontWeight: 800, letterSpacing: '-.5px' }}>Midiateca</h1>
      ...
      >
        ...
        <p style={{ fontSize: '13.5px', marginTop: '4px' }}>
          Estrutura da Fase 1 carregada. O gerenciamento completo da Midiateca será ativado na Fase 2.
        </p>
      </div>
    </div>
  );
