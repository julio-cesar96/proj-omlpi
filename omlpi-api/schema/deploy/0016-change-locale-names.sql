-- Deploy omlpi:0016-change-locale-names to pg
-- requires: 0015-random-indicator-allow-null-values

BEGIN;

CREATE TEMPORARY TABLE city_names (
  id int primary key,
  state_id int not null,
  name text not null
);

INSERT INTO city_names (id, state_id, name)
VALUES
...
UPDATE city
SET name = city_names.name
FROM city_names
WHERE city_names.id = city.id;

UPDATE locale
SET name = city_names.name
FROM city_names
WHERE city_names.id = locale.id;
