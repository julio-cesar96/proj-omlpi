-- Deploy omlpi:0018-fix-random-indicator to pg
-- requires: 0017-random-indicator-year
            ...
            FROM (
              ...
              FROM (
                ...
                WHERE indicator.id IN (random_data.a1, random_data.a2, random_data.a3)
                  AND year = (
                    select max(year) from indicator_locale il2
                    where il2.indicator_id = indicator_locale.indicator_id
                      and il2.locale_id = indicator_locale.locale_id
                  )
...
REFRESH MATERIALIZED VIEW random_locale_indicator;
REFRESH MATERIALIZED VIEW random_indicator_cache;
