  ...
  return (
    <div style={{ animation: 'fadeIn .3s ease' }}>
      <div style={{ marginBottom: '20px' }}>
        <h1 style={{ fontSize: '26px', fontWeight: 800, letterSpacing: '-.5px' }}>Usuários</h1>
      ...
      >
        ...
        <p style={{ fontSize: '13.5px', marginTop: '4px' }}>
          Estrutura da Fase 1 carregada. A gestão de usuários e permissões será ativada na Fase 3.
        </p>
      </div>
    </div>
  );
